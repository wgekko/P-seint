...
Algoritmo Integrador_zombie
	...
	Definir t,i Como Entero; definir dato Como Caracter;
	hacer 
		Escribir "Ingrese la secuencia de caracteres de ADN: ";leer sec
		sec=Mayusculas(sec); t=Longitud(sec)		
	Mientras (ValidarSecuencia1(sec,t)=Falso Y ValidarSecuencia2(sec,t)=Falso ) Hacer		
	Escribir "ERROR, dato incorrecto, ingrese nuevamente la secuencia"
	leer sec ;sec=Mayusculas(sec); t=Longitud(sec)
FinMientras
...
Funcion val <- ValidarSecuencia1(frase Por Referencia,t)	
	Definir val Como Logico; val=falso	
		si (rc(t)=3 o rc(t)=4 o rc(t)=37 ) Entonces
			val=Verdadero
		FinSi
FinFuncion

Funcion val1 <- ValidarSecuencia2(frase Por Referencia,t)
	Definir i,j,c,c1,c2,c3,c4 Como Entero;c=0;c1=0;c2=0;c3=0;c4=0
	Definir letra como caracter; Dimension letra(t)
	Definir val1 Como Logico; val1=Falso
	...
	hacer
		Para i=0 hasta t-1 Con Paso 1 Hacer//	
			...
			si (letra(i)="A" o letra(i) ="B" o letra(i) ="C" o letra(i)="D") Entonces
				...
				FinSi
			FinSi			
			si(c1>=1 y c2>=1 y c3>=1 y c4>=1 y c=t) Entonces				
				val1=Verdadero
			FinSi
		FinPara
...
Funcion igual <-Diagonales (arreglo,m,m)
	...
	Definir i,j,c,c1 Como Entero;c=0;c1=0
